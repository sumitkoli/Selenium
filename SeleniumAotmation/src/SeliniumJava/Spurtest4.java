...
System.setProperty("webdriver.chrome.driver","C:\\Driver\\chromedriver_win32 (2)\\chromedriver.exe");
		...
		//Click on "("
		w.findElement(By.xpath("//*[@id=\"sciout\"]/tbody/tr[2]/td[1]/div/div[5]/span[1]")).click();
		Thread.sleep(2000);
		...
		//Click on ")"
		w.findElement(By.xpath("//*[@id=\"sciout\"]/tbody/tr[2]/td[1]/div/div[5]/span[2]")).click();
		Thread.sleep(2000);
